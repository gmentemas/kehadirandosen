        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="input.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Input Data</a>
                    <a href="data.php" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i></i>Data Dosen</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="submit.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <p><input type='checkbox' name='jabatan' value='Kaprodi'> Ketua Program Studi</p>
                                </div>
                                <div class="mb-3">
